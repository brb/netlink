...
func (msg *XfrmReplayStateEsn) Len() int {
	// TODO(mp)
	return SizeofXfrmReplayStateEsn
}

func DeserializeXfrmReplayStateEsn(b []byte) *XfrmReplayStateEsn {
	ret := (*XfrmReplayStateEsn)(unsafe.Pointer(&b[0:SizeofXfrmReplayStateEsn][0]))
	return ret
}
